...
SECRET_KEY = 'abh-&bmzrmwgkdb%n*)e1z(kmmp+)ih)7=o6^w^8=3fozqx#&('
...
STATIC_ROOT = os.path.join(BASE_DIR, 'front/static').replace('\\', '/') # front/static即为图片上传的根路径
